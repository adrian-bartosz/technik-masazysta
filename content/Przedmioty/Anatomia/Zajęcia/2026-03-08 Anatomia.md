...
```mermaid
flowchart LR
    PK["🫀 Prawa komora"] -->|pień płucny| P["🫁 Płuca"]
    P -->|żyły płucne| LP[Lewy przedsionek]
    LP --> LK["🫀 Lewa komora"]
    LK -->|aorta| T["🦴 Tkanki i narządy"]
    T -->|żyły główne| PP[Prawy przedsionek]
    PP --> PK
    ...
    style LP fill:#85c1e9
    style PP fill:#85c1e9
```
